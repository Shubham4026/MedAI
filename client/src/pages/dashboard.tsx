...
export default function Dashboard() {
  ...
  <Card
    ...
    role="button"
    tabIndex={0}
    onKeyPress={e => { if (e.key === 'Enter' || e.key === ' ') setLocation('/find-drugs'); }}
  >
    <div className="flex items-center gap-4">
      ...
      <div>
        <h3 className="font-semibold text-yellow-700">Find Drugs</h3>
        <p className="text-sm text-muted-foreground">Search for medicines and drug info</p>
      </div>
    </div>
  </Card>
</div>
